...
f = open('eval-soa-aa/hgt/results/04_eval-hgt-transe.txt', 'w')
sys.stdout = f
...
class Model(torch.nn.Module):
    def __init__(self, out_channels):
        super().__init__()
        self.work_lin = torch.nn.Linear(128, out_channels)
        self.author_lin = torch.nn.Linear(128, out_channels) 
        self.source_lin = torch.nn.Linear(128, out_channels)
        self.publisher_lin = torch.nn.Linear(128, out_channels) 
        self.concept_lin = torch.nn.Linear(128, out_channels) 
        self.institution_lin = torch.nn.Linear(128, out_channels)

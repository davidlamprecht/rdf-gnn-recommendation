...
f = open('eval-soa-aa/graphsage/results/08_eval-graphsage-combined-addition-weighted.txt', 'w')
sys.stdout = f
...
concept_tensor = concept_tensor_literal * literal_weight + concept_embeddings_tensor * embedding_weight
author_tensor = author_tensor_literal * literal_weight + author_embeddings_tensor * embedding_weight
source_tensor = source_tensor_literal * literal_weight + source_embeddings_tensor * embedding_weight
publisher_tensor = publisher_tensor_literal * literal_weight + publisher_embeddings_tensor * embedding_weight
institution_tensor = institution_tensor_literal * literal_weight + institution_embeddings_tensor * embedding_weight

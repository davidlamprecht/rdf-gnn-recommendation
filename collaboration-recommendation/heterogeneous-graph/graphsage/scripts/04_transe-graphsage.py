...
f = open('eval-soa-aa/graphsage/results/04_eval-graphsage-transe.txt', 'w')
sys.stdout = f
...
class Model(torch.nn.Module):
    def __init__(self, hidden_channels):
        ...
        self.author_lin = torch.nn.Linear(128, hidden_channels)
        self.source_lin = torch.nn.Linear(128, hidden_channels)
        self.publisher_lin = torch.nn.Linear(128, hidden_channels)
        self.concept_lin = torch.nn.Linear(128, hidden_channels)
        self.institution_lin = torch.nn.Linear(128, hidden_channels)

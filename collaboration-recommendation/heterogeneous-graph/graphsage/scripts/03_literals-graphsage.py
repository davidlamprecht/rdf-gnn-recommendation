...
f = open('eval-soa-aa/graphsage/results/03_eval-graphsage-literals.txt', 'w')
sys.stdout = f
...
class Model(torch.nn.Module):
    def __init__(self, hidden_channels):
        super().__init__()
        self.work_lin = torch.nn.Linear(136, hidden_channels)
        self.author_lin = torch.nn.Linear(4, hidden_channels) 
        self.source_lin = torch.nn.Linear(11, hidden_channels)
        self.publisher_lin = torch.nn.Linear(6, hidden_channels) 
        self.concept_lin = torch.nn.Linear(18, hidden_channels) 
        self.institution_lin = torch.nn.Linear(12, hidden_channels)

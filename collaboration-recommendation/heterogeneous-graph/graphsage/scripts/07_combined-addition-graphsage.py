...
f = open('eval-soa-aa/graphsage/results/07_eval-graphsage-combined-addition.txt', 'w')
sys.stdout = f
...
work_tensor = torch.add(work_tensor_literal, work_embeddings_tensor)
concept_tensor = torch.add(concept_tensor_literal, concept_embeddings_tensor)
author_tensor = torch.add(author_tensor_literal, author_embeddings_tensor)
source_tensor = torch.add(source_tensor_literal, source_embeddings_tensor)
publisher_tensor = torch.add(publisher_tensor_literal, publisher_embeddings_tensor)
institution_tensor = torch.add(institution_tensor_literal, institution_embeddings_tensor)

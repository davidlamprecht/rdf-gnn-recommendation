...
f = open('eval-soa-aa/graphsage/results/09_eval-graphsage-combined-average.txt', 'w')
sys.stdout = f
...
# addition of tensors and calculate mean
work_tensor = (work_tensor_literal + work_embeddings_tensor) / 2
concept_tensor = (concept_tensor_literal + concept_embeddings_tensor) / 2
author_tensor = (author_tensor_literal + author_embeddings_tensor) / 2
source_tensor = (source_tensor_literal + source_embeddings_tensor) / 2
publisher_tensor = (publisher_tensor_literal + publisher_embeddings_tensor) / 2
institution_tensor = (institution_tensor_literal + institution_embeddings_tensor) / 2

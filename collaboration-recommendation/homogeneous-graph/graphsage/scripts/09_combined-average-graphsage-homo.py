...
f = open('eval-soa-aa-homogeneous/graphsage/results/09_eval-graphsage-homo-combined-average.txt', 'w')
sys.stdout = f
...
author_tensor = (author_tensor_nld_literal + author_embeddings_tensor) / 2

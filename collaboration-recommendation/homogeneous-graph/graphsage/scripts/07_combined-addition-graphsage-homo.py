...
f = open('eval-soa-aa-homogeneous/graphsage/results/07_eval-graphsage-homo-combined-addition.txt', 'w')
sys.stdout = f
...
author_tensor = torch.add(author_tensor_nld_literal, author_embeddings_tensor)

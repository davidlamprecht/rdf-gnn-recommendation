...
f = open('eval-soa-aa-homogeneous/graphsage/results/06_eval-graphsage-homo-combined-concatenated.txt', 'w')
sys.stdout = f
...
combined_array = np.concatenate([author_df_literals.values, author_df_nld.values, author_df_transe.values], axis=1)
...
class Model(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels):
        ...
        self.author_lin = torch.nn.Linear(260, hidden_channels)

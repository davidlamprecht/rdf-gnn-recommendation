...
f = open('eval-soa-aa-homogeneous/graphsage/results/08_eval-graphsage-homo-combined-addition-weigthed.txt', 'w')
sys.stdout = f
...
author_tensor = author_tensor_nld_literal * literal_weight + author_embeddings_tensor * embedding_weight

...
f = open('eval-soa-aa-homogeneous/graphsage/results/04_eval-graphsage-homo-transe.txt', 'w')
sys.stdout = f
...
#load data
author_csv = "soa-sw-homogeneous-author/idx/nodes-transe/author_transe.csv"
